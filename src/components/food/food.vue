            ...
            <div class="food-content">
                ...
                <div class="rating">
                    ...
                    <div class="ratingselect-wrapper">
                        <ratingselect v-on:ratingtypeSelect="ratingtypeSelect" v-on:contentToggle="contentToggle" :seletType="selectType" :onlyContent="onlyContent" :desc="desc" :ratings="food.ratings"></ratingselect>
                    </div>
